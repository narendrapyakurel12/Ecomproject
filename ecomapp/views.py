    ...
    def get_context_data(self, **kwargs):
        ...
        if cart_id:
            ...
            if this_product_in_cart.exists():
                ...
                cart_product.subtotal += pro_obj.selling_price
                cart_product.save()
                cart_obj.total += pro_obj.selling_price
                cart_obj.save()

            else:
                cart_product = CartProduct.objects.create(
                    cart=cart_obj, product=pro_obj, rate=pro_obj.selling_price, quantity=1, subtotal=pro_obj.selling_price)
                cart_obj.total += pro_obj.selling_price
                cart_obj.save()
...
class SearchView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        results = Product.objects.filter(
            Q(title__icontains=kw) | Q(return_policy__icontains=kw))
